...
use Elegance\DbLayer\Scheme\SchemeMap;
use Elegance\DbLayer\Scheme\SchemeTable;
...
class Scheme
{
    ...
    function apply(): void
    {
        ...
        DbLayer::get($this->dbName)->executeSchemeQuery($schemeQueryList);
    ...
    protected function getAlterTableFields(string $tableName, array $alterFields): array
    {
        ...
        foreach ($alterFields as $fieldName => $fieldMap) {
            ...
            $sqlFieldName = DbLayer::format_fieldName($fieldName, true);
