...
class SchemeField
{
    ...
    {
        $name = Datalayer::formatNameToDb($name);
    ...
    function getFildMap(): bool|array
    {
        ...
        switch ($map['type']) {
            ...
            case 'idx':
                $map['size'] = 10;
                $map['index'] = $map['index'] ?? true;
                $map['config']['dbName'] = Datalayer::formatNameToDb($map['config']['dbName']);
                $map['config']['table'] = Datalayer::formatNameToDb($map['config']['table']);
                break;
